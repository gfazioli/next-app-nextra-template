...
const shareUrl = 'https://next-app-nextra-template.vercel.app/';
const shareText = 'Check out this Mantine + Next.js + Nextra template';
  ...
  return (
    <Stack gap="md" align="center" id="sponsors" className={classes.sponsorsSection} my={64}>
      ...
      <Stack gap={8} align="center">
        <Text fz={11} fw={600} c="dimmed" tt="uppercase" lts={0.5}>
          Share this template
        </Text>
